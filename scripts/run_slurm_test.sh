...
srun python src/rl.py --supervised-weights=$ROOT/data/polyarg-weights-develop.dat --coq2vec-weights=$ROOT/data/term2vec-weights-59.dat $ROOT/compcert_projs_splits.json \
         ...
         --learning-rate=0.0001 -n3 -o $ROOT/data/rl_weights-compcert-5.dat -s7 --hyperparameter_search --output $ROOT/data/rl_weights.dat --test-file /home/dylan/proverbot_dat/rl_test_jobs_len5_wid5_200lines.json \
         --num-trails 1000
