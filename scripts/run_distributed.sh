...
srun --time=3:00:00 python src/rl_tuning_distributed_main.py --weightsfile=$ROOT/data/polyarg-weights-develop.dat --coq2vec_weights=$ROOT/data/term2vec-weights-59.dat \
         ...
         --learning_rate=0.0001 -n$EPOCHS -o $ROOT/data/rl_weights-compcert-5.dat -s7 --output $ROOT/data/rl_weights.dat --test_file /home/shizhuo2_illinois_edu/proverbot-dat/rl_train_jobs_len5_wid5-hyperpara-test.json \
