...
srun --time=60:00 python src/rl_tuning_distributed_main.py --weightsfile=$ROOT/data/polyarg-weights-develop.dat --coq2vec_weights=$ROOT/data/term2vec-weights-59.dat \
         ...
         --num_trails 1000 --log_root /home/shizhuo2_illinois_edu/proverbot9001_logs --result_root /home/shizhuo2_illinois_edu/proverbot9001_results --exp_name rl_distributed_1000—5epochs-3 \
         --curriculum
