...
COMMAND="python ../src/rl.py --supervised-weights=$ROOT/data/polyarg-weights-develop.dat --coq2vec-weights=$ROOT/data/term2vec-weights-59.dat $ROOT/compcert_projs_splits.json \
    ...
    --num-trials 1000 --num-cpus 10 --num-gpus 1"

python slurm-launch.py --exp-name test2 --command "$COMMAND" --num-nodes 2