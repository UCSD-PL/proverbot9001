...
for project in verdi jordan-curve-theorem GeoCoq VST distributed-reference-counting coquelicot coq cecoa buchberger; do #$(jq -r '.[55:]|.[].project_name' coqgym_projs_splits.json); do
