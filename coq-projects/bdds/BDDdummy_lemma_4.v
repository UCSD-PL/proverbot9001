...
Require Import ZArith Coq.NArith.NArith Coq.NArith.Nnat Coq.NArith.Ndec Coq.NArith.Ndigits.
...
cut
 (is_internal_node cfg (low cfg node1) ->
  is_internal_node cfg node2 ->
  max (nat_of_N (var cfg (low cfg node1))) (nat_of_N (var cfg node2)) <
  bound').
intro.
cut
 (BDDconfig_OK (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) /\
  BDDor_memo_OK (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
    (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound'))) /\
  config_node_OK (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
    (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound'))) /\
  nodes_preserved cfg (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) /\
  BDDvar_le
    (var (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
       (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound'))))
    (BDDvar_max (var cfg (low cfg node1)) (var cfg node2)) = true /\
  bool_fun_eq
    (bool_fun_of_BDD (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
       (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound'))))
...
intro.
cut
 (config_node_OK (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) node2).
intro.
cut
 (is_internal_node (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
    (high cfg node1) ->
  is_internal_node (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
    node2 ->
  max
    (nat_of_N
       (var (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
          (high cfg node1)))
    (nat_of_N
       (var (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) node2)) <
  bound').
intro.
cut
 (BDDconfig_OK
    ...
    (fst
       (snd
          (BDDor_1 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
             (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
             (high cfg node1) node2 bound'))) /\
  nodes_preserved (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
    (fst
       (BDDor_1 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
          (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
          (high cfg node1) node2 bound')) /\
  ...
  (Neqb (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
     (fst
        (snd
           (BDDor_1 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
              (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
              (high cfg node1) node2 bound'))) = false ->
   MapGet _
     (fst
        (fst
           (BDDmake
              (fst
                 (BDDor_1
                    (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
                    (snd
                       (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
                    (high cfg node1) node2 bound')) 
              (var cfg node1)
              (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
              (fst
  ...
  (Neqb (fst (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
     (fst
        (snd
           (BDDor_1 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
              (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
              (high cfg node1) node2 bound'))) = true ->
   snd
     (BDDmake
        (fst
           (BDDor_1 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
...
rewrite
 (BDDor_1_lemma_internal_3 cfg memo node1 node2 bound bound' y H0 H8 H7 H10
    y0 y1).
simpl in |- *.
rewrite
          ...
          (fst
             (snd
                (BDDor_1
                   (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
                   (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
                   (high cfg node1) node2 bound'))))) node1').
intro.
cut
 (config_node_OK
    (fst
          ...
          (fst
             (snd
                (BDDor_1
                   (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
                   (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
                   (high cfg node1) node2 bound'))))) node2').
intro.
cut
 (config_node_OK
    (fst
          ...
          (fst
             (snd
                (BDDor_1
                   (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
                   (snd (snd (BDDor_1 cfg memo (low cfg node1) node2 bound')))
                   (high cfg node1) node2 bound'))))) node).
intro.
split.
assumption.
...
apply
 nodes_preserved_2
  with (cfg := fst (BDDor_1 cfg memo (low cfg node1) node2 bound')).
                          ...
                          (snd
                             (snd
                                (BDDor_1 cfg memo (low cfg node1) node2
                                   bound'))) (high cfg node1) node2 bound'))))
              (bool_fun_of_BDD
                 (fst
                    (BDDor_1
                       (fst (BDDor_1 cfg memo (low cfg node1) node2 bound'))
  ...
  with
    (bf2 := bool_fun_or
              (bool_fun_of_BDD
                 ...
                 (high cfg node1))
              (bool_fun_of_BDD
                 (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) node2)).
assumption.
...
apply
 nodes_preserved_trans
  with (cfg2 := fst (BDDor_1 cfg memo (low cfg node1) node2 bound')).
assumption.
...
cut
 (var (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) (high cfg node1) =
  var cfg (high cfg node1)).
intro.
rewrite H34.
cut
 (var (fst (BDDor_1 cfg memo (low cfg node1) node2 bound')) node2 =
...
apply
 BDDcompare_le_INFERIEUR_1
  with (y := BDDvar_max (var cfg (low cfg node1)) (var cfg node2)).
assumption.
