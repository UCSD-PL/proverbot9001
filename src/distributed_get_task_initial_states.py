...
def get_states(args: argparse.Namespace, unique_id: uuid.UUID = uuid.uuid4()) -> None:
    ...
    if num_workers_actually_needed > 0:
        ...
        progress_arg = f"--progress" if args.progress else ""
...
python -u src/distributed_get_task_initial_states_worker.py {task_file_arg} {output_arg} {progress_arg} {prelude_arg} \
