            ...
            if unique_lemma_statement == job_lemma and \
              self.coq.sm_prefix == job_module:
                ...
                self.lemmas_encountered.append(ReportJob(self.cur_project,
                                                         ...
                                                         self.coq.sm_prefix,
                                                         unique_lemma_statement, [])) #todo: tactic_prefix in this case
    ...
    try:
        if args.search_type == 'dfs':
            ...
            result = best_first_proof_search(lemma_name, module_prefix,
                                             context_lemmas, coq,
                                             output_dir,
                                             args, bar_idx, predictor) #proofs_done
            proofs_done.append(ReportJob(".", "lib/Parmov.v", module_prefix, lemma_name)) #todo: unhardcode
        else:
