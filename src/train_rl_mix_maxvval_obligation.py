...
def NN_VLearning(T_max, gamma, args) :
	...
	if args.use_fast_check :
		env = FastProofEnv(proof_files, args.prelude, args.wandb_log, state_type = "obligation_index", max_proof_len = args.max_proof_len, num_check_engines = args.max_attempts, info_on_check = True)
	else :
		env = ProofEnv(proof_files, args.prelude, args.wandb_log, state_type = "obligation_index",  max_proof_len = args.max_proof_len, info_on_check=True)
