...
# from models.features_polyarg_predictor import FeaturesErrorsState
import dataloader
...
class FeaturesErrorsSample(NamedTuple):
    num_hyps: int
...
class FeaturesErrorsDataset(ListDataset[FeaturesErrorsSample]):
    pass


FeaturesErrorsState = Tuple[Any, NeuralPredictorState]
...
class FeaturesErrorsModel(nn.Module):
    def __init__(self,
...
class FeaturesErrorsPredictor(
        TrainablePredictor[FeaturesErrorsDataset,
    ...
    def __init__(self) -> None:
        ...
        self._model: Optional[FeaturesErrorsModel] = None
    ...
    def predict_stems(self, model: FeaturesErrorsModel,
                      k: int,
    ...
    def goal_token_scores(self, model: FeaturesErrorsModel, args: argparse.Namespace,
    ...
    def _encode_data(self, data: RawDataset, arg_values: Namespace) \
        -> Tuple[FeaturesErrorsDataset, Tuple[Tokenizer, Embedding,
                                               List[WordFeature], List[VecFeature]]]:
        pass

    def _optimize_model(self, arg_values: Namespace) -> Iterable[FeaturesErrorsState]:
    ...
    def _getBatchPredictionLoss(self, arg_values: Namespace,
                                ...
                                model: FeaturesErrorsModel) -> torch.FloatTensor:
...
def main(arg_list: List[str]) -> None:
    predictor = FeaturesErrorsPredictor()
