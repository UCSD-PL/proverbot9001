...
from tactic_classes import TacticClass, getTacticClass
...
class ClassPolyargPredictor(
    ...
    def predictClasses(self, context: TacticContext) -> List[TacticClass]:
        return [TacticClass.GOAL_TOUCHER, TacticClass.HYP_TOUCHER, TacticClass.OTHER]
