...
def reinforce_jobs(args: argparse.Namespace) -> None:
    ...
    if args.tasks_file:
        ...
        for task in partial_tasks:
            partial_task_job = ReportJob(project_dir=".", filename=task['src_file'], module_prefix=task['module_prefix'], 
                    lemma_statement=task['proof_statement'], tactic_prefix=task['tactic_prefix'])
