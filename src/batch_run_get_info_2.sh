...
python ./src/proverbot9001.py predictor-data --weightsfile data/polyarg-weights.dat --weightsfiles data/no-hyp-scores-weights.dat --scrapefile data/compcert-scrape.txt --dest ./comb_pred_2.csv
