...
def add_args_to_parser(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--search-type", choices=['dfs', 'dfs-subgoal', 'dfs-vote', 'dfs-vote-subgoal-combo', 'dfs-vote-cheap-exp-combo', 'dfs-bid', 'dfs-bid-subgoal-combo', 'dfs-bid-cheap-exp-combo', 'dfs-cheap-exp', 'dfs-est', 'dfs-multimodal', 'dfs-multimodal-subgoal-combo', 'dfs-multimodal-cheap-exp-combo', 'beam-bfs', 'astar', 'best-first', 'rnn-dfs', 'rnn-dfs-subgoal-combo', 'rnn-dfs-cheap-exp-combo'], default='dfs')
