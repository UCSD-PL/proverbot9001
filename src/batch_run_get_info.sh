...
python ./src/proverbot9001.py predictor-data --weightsfile data/polyarg-weights.dat --weightsfiles data/polyarg-weights.dat data/no-hyp-scores-weights.dat data/no-prev-tactic-weights.dat data/no-goal-head-weights.dat --scrapefile data/compcert-scrape.txt --dest ./new_combined_predictor_data_two.csv
